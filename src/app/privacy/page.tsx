          ...
          <section className="bg-[#0A637D]/5 border border-[#0A637D]/20 rounded-xl p-6 mt-8">
            ...
            <ul className="space-y-2">
              <li className="flex gap-2">
                ...
                <span>Heru Sigit Pramono (Software Developer) - Petugas Pelindungan Data</span>
              </li>
              <li className="flex gap-2">
