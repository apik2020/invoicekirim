        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-10 space-y-8 text-gray-700 text-sm leading-relaxed">
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2">
              <li>
                <strong>&quot;NotaBener&quot;</strong> (&quot;Platform&quot;) adalah layanan berbasis web yang disediakan oleh <strong>Trust Benar Digital</strong> (&quot;Penyedia&quot;) yang memungkinkan Pengguna untuk membuat, mengelola, dan mengirimkan dokumen penagihan (invoice/faktur) secara digital melalui email dan WhatsApp.
              </li>
              <li>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2">
              <li>Seluruh konten, desain, logo, merek dagang, kode sumber, dan fitur-fitur pada Platform merupakan hak kekayaan intelektual milik <strong>Trust Benar Digital</strong> yang dilindungi oleh hukum hak cipta dan merek dagang yang berlaku di Indonesia.</li>
