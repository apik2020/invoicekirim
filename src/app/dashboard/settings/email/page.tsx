      ...
      <FeatureGate
        ...
        fallback={
          <div className="text-center py-16">
            ...
            <h2 className="text-2xl font-bold text-brand-500 mb-3">Pengaturan Email</h2>
            <p className="text-text-secondary mb-6 max-w-md mx-auto">
              Konfigurasi email untuk mengirim invoice ke klien. Fitur ini tersedia untuk pengguna Pro.
            </p>
            <Link
              href="/checkout"
